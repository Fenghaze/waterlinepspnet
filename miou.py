...
def compute_mIoU(gt_dir, pred_dir, png_name_list, num_classes, name_classes):  
    ...
    for ind in range(len(gt_imgs)): 
        ...
        #------------------------------------------------#
        if Image.open(gt_imgs[ind]) is None:
            continue
...
if __name__ == "__main__":
    gt_dir = r"D:\Deeplearning\data\ship_test\out\label"
    pred_dir = "miou_pr_dir"
    png_name_list = open(r"D:\Deeplearning\data\ship_test\out\test.txt",'r').read().splitlines()
    #------------------------------#
    #   分类个数+1
    #------------------------------#
    num_classes = 2
